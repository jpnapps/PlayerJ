...
class VFolderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.VistaVFolderRV)
        ...
        if(videosFiles.size > 0) {
            val vistaVFolderAdapter = VistaVFolderAdapter(this, videosFiles)
            recyclerView.adapter = vistaVFolderAdapter
    ...
    @RequiresApi(Build.VERSION_CODES.Q)
    fun obtenerVideos(context: Context, nombreVFolder: String): ArrayList<VideosFiles> {
        ...
        val seleccionArgs = arrayOf<String>("%" + nombreVFolder + "%")
