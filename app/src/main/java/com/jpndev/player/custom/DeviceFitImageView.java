package com.jpndev.player.custom;
...
public class DeviceFitImageView extends ImageView {
        ...
        if(drawable == null) {
           ...
           /*         newWidth= Resources.getSystem().getDisplayMetrics().widthPixels/3;
                ...
                case IMAGE_FIXED:
                    ...
                    LogUtils.LOGD("jp", " OTHER IMAGE_FIXED " + newHeight);
                    break;
                default:
                    throw new IllegalStateException("Unknown measurement with ID " + dominantMeasurement);
            }
          //  LogUtils.LOGD("jp", "dimv onMeasure  newWidth" + newWidth);
         //   LogUtils.LOGD("jp", "dimv onMeasure  newHeight" + newHeight);
    ...
    {
        LogUtils.LOGD("jp", "dimv setHeightWidth  heightMeasureSpec " + heightMeasureSpec);
    ...
    public void setAspectWidth(int pw)
    {
        ...
        LogUtils.LOGD("jp", "dimv setAspectWidth  aspectRatio " + aspectRatio);
        ...
        setMeasuredDimension(widthMeasureSpec, heightMeasureSpec);
        requestLayout();
        LogUtils.LOGD("jp", "dimv setAspectWidth   heightMeasureSpec changed " + heightMeasureSpec);
        LogUtils.LOGD("jp", "dimv setAspectWidth   widthMeasureSpec  changed" + widthMeasureSpec);

    }

    public void setPercentWidth(int widthMeasureSpec, int heightMeasureSpec,int pw)
    {
        LogUtils.LOGD("jp", "dimv setPercentWidth   heightMeasureSpec " + heightMeasureSpec);
        LogUtils.LOGD("jp", "dimv setPercentWidth   widthMeasureSpec " + widthMeasureSpec);
        double aspectRatio=(double)widthMeasureSpec/heightMeasureSpec;
        widthMeasureSpec = Resources.getSystem().getDisplayMetrics().widthPixels * pw / 100;
        LogUtils.LOGD("jp", "dimv setPercentWidth  aspectRatio " + aspectRatio);
        heightMeasureSpec = (int) (widthMeasureSpec /aspectRatio);
        ...
        newHeight=heightMeasureSpec;
        setMeasuredDimension(widthMeasureSpec, heightMeasureSpec);
        LogUtils.LOGD("jp", "dimv setPercentWidth   heightMeasureSpec changed " + heightMeasureSpec);
        LogUtils.LOGD("jp", "dimv setPercentWidth   widthMeasureSpec  changed" + widthMeasureSpec);
  ...
  /*  @Override
    ...
    {
        LogUtils.LOGD("jp", "dimv setAspectHeightWidth   heightMeasureSpec " + heightMeasureSpec);
        LogUtils.LOGD("jp", "dimv setAspectHeightWidth   widthMeasureSpec " + widthMeasureSpec);
